...
from cart.views import add_to_cart,view_cart,remove_from_cart,wish_list,view_wishlist,cart_add,cart_sub,checkout
...
urlpatterns = [
    ...
    # path('subtotal/',sub_total,name = 'sub_total')
